...
/**
 * A {@link de.hpi.isg.mdms.domain.Location} representing a HDFS location.
 * 
 * 
 */
...
public class DefaultLocation extends AbstractHashCodeAndEquals implements Location {
    ...
    public static de.hpi.isg.mdms.domain.location.impl.DefaultLocation createForFile(String path) {
        de.hpi.isg.mdms.domain.location.impl.DefaultLocation location = new de.hpi.isg.mdms.domain.location.impl.DefaultLocation();
