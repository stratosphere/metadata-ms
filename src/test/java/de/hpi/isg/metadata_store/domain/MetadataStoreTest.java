...
public class MetadataStoreTest {
	...
	IConstraint dummyContraint = new TypeConstraint(5, "dummyTypeConstraint",
	...
	// setup schema
	ISchema dummySchema1 = Schema.buildAndRegister(store1, 2, "PDB", new HDFSLocation("hdfs://foobar")).addTable(
		Table.buildAndRegister(store1, 45, "foo", null));
	...
	Collection<ITarget> allTargets1 = store1.getAllTargets();
	Collection<ITarget> allTargets2 = store2.getAllTargets();
