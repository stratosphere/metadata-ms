...
public class ConstraintTest {
	...
	public void testTypeConstraint() {
		...
		IConstraint dummyTypeContraint1 = new TypeConstraint(3, "dummyTypeConstraint", new SingleTargetReference(dummyColumn));
		IConstraint dummyTypeContraint2 = new TypeConstraint(3, "dummyTypeConstraint", new SingleTargetReference(dummyColumn));
	...
	public void testAddingConstraintsToUnmodifiableConstraintCollectionFails() {
		...
		IConstraint dummyTypeContraint = new TypeConstraint(3, "dummyTypeConstraint", new SingleTargetReference(dummyColumn));
	...
	public void testTypeConstraintOnAddedColumn() {
		...
		store3.getSchemas().add(Schema.buildAndRegister(store3, 3, "dummySchema", null).addTable(Table.buildAndRegister(store3, 4, "dummyTable", null).addColumn(dummyColumn)));
