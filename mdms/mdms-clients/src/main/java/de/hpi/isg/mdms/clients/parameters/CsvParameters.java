...
public class CsvParameters {
    ...
    private void initialize() {
        ...
        if (this.fieldSeparatorName.length() == 1) {
            this.fieldSeparatorChar = this.fieldSeparatorName.charAt(0);
        } else if ("comma".equalsIgnoreCase(this.fieldSeparatorName)) {
        ...
        if (this.quoteCharName.length() == 1) {
            this.quoteChar = this.quoteCharName.charAt(0);
        } else if ("none".equalsIgnoreCase(this.quoteCharName)) {
