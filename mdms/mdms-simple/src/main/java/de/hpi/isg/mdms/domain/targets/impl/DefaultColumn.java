...
/**
 * The default implementation of the {@link de.hpi.isg.mdms.domain.targets.Column}.
 *
 */
...
public class DefaultColumn extends AbstractTarget implements Column {
    ...
    public static Column buildAndRegister(final Observer observer, final Table table, final int id, final String name,
        ...
        final de.hpi.isg.mdms.domain.targets.impl.DefaultColumn newColumn = new de.hpi.isg.mdms.domain.targets.impl.DefaultColumn(observer, table, id, name, description, location);
        newColumn.register();
        return newColumn;
    }
    ...
    public static Column buildAndRegister(final Observer observer, final Table table, final String name,
            final String description,
            final Location location) {
        final de.hpi.isg.mdms.domain.targets.impl.DefaultColumn newColumn = new de.hpi.isg.mdms.domain.targets.impl.DefaultColumn(observer, table, -1, name, description, location);
        newColumn.register();
        return newColumn;
    }
