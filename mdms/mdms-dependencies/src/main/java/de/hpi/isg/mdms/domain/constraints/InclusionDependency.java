...
/**
 * {@link Constraint} implementation for an n-ary inclusion dependencies.
 *
 * @author Sebastian Kruse
 */
public class InclusionDependency extends AbstractHashCodeAndEquals implements Constraint {
