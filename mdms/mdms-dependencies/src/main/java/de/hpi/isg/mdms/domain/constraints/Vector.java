...
/**
 * This {@link Constraint} represents a {@link Column} as a vector.
 *
 * @author Sebastian Kruse
 */
public class Vector extends AbstractHashCodeAndEquals implements Constraint {

    private int columnId;

    private double[] values;

    public Vector(int columnId, double[] values) {
