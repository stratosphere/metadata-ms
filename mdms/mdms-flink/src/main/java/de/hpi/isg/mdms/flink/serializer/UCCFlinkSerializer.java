...
public class UCCFlinkSerializer implements AbstractFlinkSerializer<UniqueColumnCombination, Tuple1<int[]>> {
	...
	@Override
	public UniqueColumnCombination buildAndAddToCollection(Tuple1<int[]> tuple, ConstraintCollection constraintCollection) {
    ...
    private static final class CreateINDs implements GroupReduceFunction<Tuple2<Integer, Integer>, Tuple1<int[]>> {
